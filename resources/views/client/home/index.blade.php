...
<head>
    ...
    <title>{{ $page }} | Sistem Informasi Kampus</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        @php
                            $navigationSelected = $data->navigation;
                            $navigationSelected = explode(',', $navigationSelected);
                        @endphp
                        @foreach ($navigationSelected as $navigation)
                            <li class="nav-item">
                                <a class="nav-link" href="/{{ strtolower($navigation) }}">{{ $navigation }}</a>
                            </li>
                        @endforeach
                    </ul>

                    <div class="ms-4">
                        <a href="/{{ strtolower($data->navigation_button) }}"
                            class="btn custom-btn custom-border-btn smoothscroll">{{ $data->navigation_button }}</a>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="text-center mb-5 pb-2">
                            <h1 class="text-dark">{{ $data->headline }}</h1>

                            <p class="text-dark">{{ $data->description }}</p>

                            <a href="#section_2" class="btn custom-btn smoothscroll mt-3">{{ $data->button_label }}
                                👇</a>
                        </div>
                    </div>
    ...
    <footer class="site-footer text-center">
        <p class="copyright-text mb-0 pt-4">Copyright &copy; {{ date('Y') }}</p>
    </footer>
